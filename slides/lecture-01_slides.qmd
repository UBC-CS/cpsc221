...
- Instructors: {{< var instructor.name >}} (Sec {{< var instructor.section >}}) — {{< var instructor.email >}} · {{< var instructor2.name >}} (Sec {{< var instructor2.section >}}) — {{< var instructor2.email >}} · OH: <TODO-office-hours>
